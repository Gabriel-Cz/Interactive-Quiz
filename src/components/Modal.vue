        ...
        <div class="modal">
           <div class="svg-Wrapper">
               ...
               <svg v-else version="1.1" id="Capa_1" width="50%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <button class="mobileButton" @click="closeModelAndAdvance(false, getNextNumber)">Next Question</button>
           </div>
           <button class="normalButton" @click="closeModelAndAdvance(false, getNextNumber)">Next Question</button>
       </div>
    </div>
</template>
